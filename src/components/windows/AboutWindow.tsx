...
const timelineItems: {
  ...
  { year: "2026", heading: "Product Lab: case studies", description: "Archive of product thinking: CAPTCHA, Patagonia phone, clinic queues, Wikipedia maps, and a Nothing AI assistant.", tags: ["Product Thinking", "Redesign", "Speculative"], target: { windowId: "product-lab", entryId: "glyph-home" }, lane: "initiative" },
