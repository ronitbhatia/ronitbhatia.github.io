...
const timelineItems: {
  ...
  { year: "2026", heading: "Product Lab: case studies", description: "Archive of product thinking: Fitbit monitor, Google treadmill, Nothing AI assistant, Wikipedia maps, clinic queues, Patagonia phone, and CAPTCHA.", tags: ["Product Thinking", "Redesign", "Speculative"], target: { windowId: "product-lab", entryId: "fitbit-focus-monitor" }, lane: "initiative" },
