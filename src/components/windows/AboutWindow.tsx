...
const timelineItems: {
  ...
  { year: "2026", heading: "Product Lab: case studies", description: "Archive of product thinking: iPhone Air Monocoque, Casio tracker, Hermès headset, Rolex power bank, Rhode camera, Fitbit monitor, Google treadmill, Nothing AI, Wikipedia maps, clinic queues, Patagonia phone, and CAPTCHA.", tags: ["Product Thinking", "Redesign", "Speculative"], target: { windowId: "product-lab", entryId: "iphone-air-monocoque" }, lane: "initiative" },
