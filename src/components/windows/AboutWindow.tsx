...
const timelineItems: {
  ...
  { year: "2026", heading: "Product Lab: case studies", description: "Archive of product thinking: Casio tracker, Hermès headset, Rolex power bank, Rhode camera, Fitbit monitor, Google treadmill, Nothing AI, Wikipedia maps, clinic queues, Patagonia phone, and CAPTCHA.", tags: ["Product Thinking", "Redesign", "Speculative"], target: { windowId: "product-lab", entryId: "casio-dist-finder" }, lane: "initiative" },
